# -*- coding: utf-8 -*-
#
# django-pgactivity documentation build configuration file, created by
...
version = pgactivity.__version__
...
htmlhelp_basename = "django-pgactivitydoc"
...
latex_documents = [
    (
        master_doc,
        "django-pgactivity.tex",
        "django-pgactivity Documentation",
        "Opus 10",
        "manual",
    )
]
